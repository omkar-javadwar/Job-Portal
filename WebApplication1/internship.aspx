<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="internship.aspx.cs" Inherits="WebApplication1.company" %>
          ...
          <div class="carousel-item active">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2>LEARN</h2>
				  <h4>Anytime. Anywhere. Affordable</h4>
    ...
    <div class="col-sm-3">
        <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            ...
            <a href="companyinfo.aspx" class="card-link">Know More</a>
          </div>
        </div>
    </div>
